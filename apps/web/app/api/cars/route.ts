...
try{
    ...
    .where(
        or(
          and(
            gte(cars.insuranceEndDate, sevenDaysFromNowStart),
            lte(cars.insuranceEndDate, sevenDaysFromNowEnd)
          ),
          and(
            gte(cars.inspectionEndDate, sevenDaysFromNowStart),
            lte(cars.inspectionEndDate, sevenDaysFromNowEnd)
          ),
          and(
            gte(cars.insuranceEndDate, fourteenDaysFromNowStart),
            lte(cars.insuranceEndDate, fourteenDaysFromNowEnd)
          ),
          and(
      ...
      const notificationsByOrg = new Map<string, {
