  ...
  return (
    <div>
        <form id="add-worker-form" action={formAction}>
            ...
            <Button className='hover:bg-red-500/90 cursor-pointer' type="button" variant='destructive' onClick={() => setIsOpen(false)}>Anuluj</Button>
            <Button className='hover:bg-primary/90 cursor-pointer' type="submit" form="add-worker-form" disabled={isPending}>Dodaj pracownika</Button>
            </div>
            </div>
        </form>
    </div>
